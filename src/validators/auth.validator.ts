...
export const registerSchema = z.object({
  ...
  cardId: z.string().length(13, 'Card Id must be exactily 13 characters long').min(1, { message: 'Card Id is required' }).optional(),
  email: z.string().email('Email must be a valid email address').min(1, { message: 'Email is required' }),
